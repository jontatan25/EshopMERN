...
import "./style.css";
const socket = io.connect("https://jhonndevshop.vercel.app/api/");
...
const Chat = () => {
  ...
  const getInfo = async (token) => {
    if (email) {
      try {
        const res = await axios.get(
          "https://jhonndevshop.vercel.app/api/messages/email/" + email,
          {
    ...
    try {
      const res = await axios.get("https://jhonndevshop.vercel.app/api/messages", {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  let handleSumbitMessage = async (e) => {
    ...
    try {
      var res = await axios.post("https://jhonndevshop.vercel.app/api/messages", message, {
        headers: { Authorization: `Bearer ${token}` },
      });
