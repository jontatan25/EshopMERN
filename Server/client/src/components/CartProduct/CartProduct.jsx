    ...
    <>
      <div className="cart__product-container">
        <div className="cart__title__product">
          ...
          <div className="cart__product-det">
            <h5 className="cart__product-title">{product.name}</h5>
            <svg
              width="20"
              height="20"
              viewBox="0 0 23 23"
        ...
        <span className="cart__title__price">{product.price},00 USD</span>
        <span className="cart__title__size">{product.size}</span>
        ...
        <div className="cart__title__total">
          ...
          <button
            ...
            onClick={() => deleteItemByID(product._id)}
          >
            <svg
              width="24"
              height="24"
      ...
      <div className="product__container-mobile">
        <div className="mobile__top">
          <div
            className="mobile__top-photo"
            style={{ backgroundImage: `url(${product.URLPhoto})` }}
          ></div>
          <div className="mobile__top-info">
            <h5 className="cart__product-title">{product.name}</h5>
            <span className="cart__title__size">
              <h6 className="mobile__subtitle">Size:</h6>
              {product.size}
            </span>
            <div className="mobile__color-container">
              <h6 className="mobile__subtitle">Color:</h6>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        <div className="mobile__bottom">
          <h6 className="cart__title__size" id="mobiletext">
            QUANTITY
          </h6>
          <div className="mobile__bottom-price-container">
            <div className="cart__title__quantity">
              <QuantitySelector
                cartMode={true}
                id={product._id}
                quantityInCart={product.quantity}
          ...
          <div className="mobile__top-price"><h6 className="mobile__subtitle">Price:</h6>{product.price},00 USD</div>
          </div>
        </div>
      </div>
    </>
